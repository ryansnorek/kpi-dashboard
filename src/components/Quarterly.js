  ...
  return (
    <section className="quarterly">
      <div className="period">
        <button id={qtrID("1")} name="1" onClick={handleClickQtr}>1Q22</button>
        <button id={qtrID("2")} name="2" onClick={handleClickQtr}>2Q22</button>
        <button id={qtrID("3")} name="3" onClick={handleClickQtr}>3Q22</button>
        <button id={qtrID("4")} name="4" onClick={handleClickQtr}>4Q22</button>
      </div>
